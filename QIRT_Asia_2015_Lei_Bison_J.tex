...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.35]{Camera_setup}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{Sph_1}
	\includegraphics[scale=0.5]{Sph_2}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.44]{img7}
	\includegraphics[scale=0.44]{sph_img7}
...
\begin{figure}[ht]
	%	\centering
	\includegraphics[scale=0.65]{Harris1}
	\includegraphics[scale=0.65]{Harris2}
	\caption{Harris corners detected (green crosses) in the Fig 4 and its precedent image of the whole series. In these two continus images, the IR camera scanned from top to bottom inside the vehicle and there is a ``clear" (from our vision) overlapping part (left bottom part in the first and left top part in the second) in these two images. However, from the Harris corners detection results, all the features obtained could not be matched correctly.}
	\label{Harris}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.45]{img_trs}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.4]{img_sti}
...
%	\centering
	\hspace*{-20pt}
	\includegraphics[scale=0.3]{Pano_T_Final}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.45]{QIRT2015Aisa_Fig8}
...
%	\centering
	\hspace*{-20pt}
	\includegraphics[scale=0.3]{Pano_Q_Final}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.55]{Image2}
...
%	\centering
	\hspace*{-20pt}
	\includegraphics[scale=0.4]{AM_map}
...
\begin{equation}
K_{th}=\frac{\bar{q}}{\Delta ̅\theta} =\frac{11.724 W/m^2}{(32.79-7.5) K}=0.464 W/m^2∙K 
\end{equation}
